            ...
            <div>
                <header>
                    {/* <section className="navsection">
                        <nav>
                            <ul class="nav-bar">
                                <li class="logo"><img src="./images/NJ-Logo.png" alt="" /></li>
                    ...
                    <div className="service-box">
                        <div className="single-service">
                            ...
                            <div className="service-desc">
                                ...
                                <NavLink to="/Male1" href="#"><button className='btn'>View More</button></NavLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="service-box">
                        <div className="single-service">
                            ...
                            <div className="service-desc">
                                ...
                                <hr />
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet officiis aliquid magni soluta ipsa perferendis illum labore quia sit veritatis!</p>
                                <NavLink to ="/Female" href="#"><button className='btn'>View More</button></NavLink>
                            </div>
                        </div>
                    </div>
                </section>
